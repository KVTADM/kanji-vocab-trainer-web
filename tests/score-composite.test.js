// Contrôles du score composite (#5, rang 5) : scoreComposite(),
// positionSemestre() et getScoreCompositePersonnel() dans app.js.
//
...
//
// À lancer depuis la racine du dépôt : node tests/score-composite.test.js
...
const SRC = fs.readFileSync(__dirname + '/score-composite.cases.js', 'utf8');
eval(SRC);
