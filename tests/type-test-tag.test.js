// Contrôles de libelleFiltreMots() et du suivi du filtre "Mots" sur les
// scores enregistrés (09/09/2026) : voir tests/type-test-tag.cases.js pour
// le contexte complet.
//
// Fonctions pures, aucune dépendance au DOM : même bloc "Aides sur les
// données" qu'utilisent déjà tests/kanji-quiz.test.js et
// tests/dashboard-reco.test.js.
//
// À lancer depuis la racine du dépôt : node tests/type-test-tag.test.js
...
const CAS = fs.readFileSync(__dirname + '/type-test-tag.cases.js', 'utf8');
